...
import com.unknow.client.screen.componet.CustomButton;
...
import static com.unknow.client.screen.componet.CustomButton.convertToBufferedImage;
...
public class StartScreen extends Screen {
    ...
    public StartScreen(Player player) {
        super("START_SCREEN");
        Image image = ImageResources.getImage("images/Uno/test.jpg");
    ...
    private void joinGame() {
        //这里模拟
        Game.screens().add(new GameTableScreen(new ClientInfo(player.getId(), player.getName())));
        // TODO:添加网络连接逻辑
    }
}